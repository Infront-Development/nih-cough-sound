...
class questionnairedata(models.Model):
    ...
    respondent_choices = models.CharField(max_length = 50, choices=respondent_choices, default='', verbose_name=_('Which group of respondents you are?'))
    respondent_sex = models.CharField(max_length=50, choices=respondent_sex, default='', verbose_name=_('What is your biological sex?'))
    age = models.IntegerField(verbose_name=_('How old are you?'))
    med_cond_opt = MultiSelectField(choices=med_cond_opt, default=False, verbose_name=_('Do you have any of these medical conditions? (can choose more than one)'))
    respondent_smoke = models.CharField(max_length=100, choices=respondent_smoke, default='', verbose_name=_('Do you, or have you, ever smoked (including e-cigarettes)?'))
